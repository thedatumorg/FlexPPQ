...
inline float fvec_L2sqr (const float * x,
                  const float * y,
                  size_t d)
{
...
inline void fvec_op_ny_D1 (float * dis, const float * x,
...
template<class ElementOp>
inline void fvec_op_ny_D2 (float * dis, const float * x,
                       const float * y, size_t ny)
{
...
template<class ElementOp>
inline void fvec_op_ny_D4 (float * dis, const float * x,
                        const float * y, size_t ny)
{
...
template<class ElementOp>
inline void fvec_op_ny_D8 (float * dis, const float * x,
                        const float * y, size_t ny)
{
    __m128 x0 = _mm_loadu_ps(x);
...
template<class ElementOp>
inline void fvec_op_ny_D12 (float * dis, const float * x,
                        const float * y, size_t ny)
{
    __m128 x0 = _mm_loadu_ps(x);
    __m128 x1 = _mm_loadu_ps(x + 4);
...
inline void fvec_L2sqr_ny (float * dis, const float * x,
